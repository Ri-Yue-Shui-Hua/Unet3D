...
```python
def train(net, dataset, val_rate, epochs, batch_size, lr, sigma, saved_epoch_step, model_str=''):
    ...
    for epoch in range(epochs):
        ...
        if epoch % saved_epoch_step == 0:
            ...
            saved_model_name = model_str + '_' + t + f'LR_{lr}_BS_{batch_size}_{crit}_ep_{epoch}_{epochs}_sigma_{sigma}' + str(loss.item()) + '.pth'
